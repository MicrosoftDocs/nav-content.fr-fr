...
3. Renseignez les champs comme nécessaire afin de créer un compte général pour les recettes échelonnées. Pour plus d'informations, reportez-vous à [Les écritures comptables et le plan comptable](finance-setup-general-ledger.md).
3. Répétez les étapes 2 et 3 pour créer un nouveau compte général pour les dépenses échelonnées.
...
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, saisissez **Modèles échelonnement**, puis sélectionnez le lien connexe.
2. Sélectionnez l'action **Nouveau**.
...
1. Dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, saisissez **Résumé échelonnement ventes**, puis sélectionnez le lien connexe.
