...
---
# <a name="how-to-post-payment-slips"></a>Procédure : valider des bordereaux paiement
...
Avant de publier un bordereau paiement, vous devez créer le bordereau paiement. Pour plus d'informations, consultez [Procédure : créer des bordereaux paiement](how-to-create-payment-slips.md).  
