...
2.  Dans la fenêtre **Calculer amortissement**, sur le raccourci **Options**, renseignez les champs comme indiqué dans le tableau suivant.  
    ...
    |**Date de validation**|Date de validation de l'amortissement calculé.<br /><br /> Vous pouvez laisser ce champ vide si le champ **Mêmes dates compta./immo.** dans la loi d'amortissement comptable est sélectionné. La date comptabilisation est copiée sur les lignes feuille. Pour plus d'informations, voir [($ T_5611_19 Use Same FA+G-L Posting Dates $)](($%20T_5611_19%20Use%20Same%20FA+G-L%20Posting%20Dates%20$).md).|  
