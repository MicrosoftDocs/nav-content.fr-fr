...
3. Dans le champ **N°**, saisissez le numéro du contact.
    ...
    Si vous avez configuré une souche de numéros pour les contacts dans la fenêtre **Paramètres Marketing**, appuyez sur la touche Entrée pour sélectionner le numéro de contact suivant. Pour plus d'informations, reportez-vous à [Création des souches de numéros](ui-create-number-series.md).
...
[Configurer des groupes distribution sur les contacts](marketing-mailing-groups.md#assign-mailing-groups-to-a-contact)
