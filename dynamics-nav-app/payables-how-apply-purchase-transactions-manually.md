...
# <a name="how-to-apply-vendor-payments-manually"></a>Procédure : lettrer les paiements fournisseur manuellement
...
7. Ou, pour lettrer plusieurs écritures comptables fournisseur :
...
4. Pour lettrer une seule écriture comptable fournisseur :
5. Sur le raccourci **Lettrage**, dans le champ **N° doc. lettrage**, sélectionnez l'écriture à lettre à un crédit.
6. Sur la ligne du champ **Montant à lettrer**, entrez le montant à lettrer à l'écriture.
7. Ou, pour lettrer plusieurs écritures comptables fournisseur :
8. Sélectionnez l'action **Lettrer écritures**.
9. Sélectionnez les lignes contenant les écritures auxquelles lettrer l'avoir.
10. Sélectionnez l'action **Lettrer**.  
11. Sur chaque ligne du champ **Montant à lettrer**, entrez le montant à lettrer à l'écriture.
...
Le lettrage d'écritures comptables fournisseur en devises différentes doit être activé. Pour plus d'informations, reportez-vous à [Procédure : activer le lettrage d'écritures comptables client en devises différentes](finance-setup-how-enable-application-ledger-entries-different-currencies.md)
