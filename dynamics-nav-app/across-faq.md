...
Si vous avez des questions à propos de [!INCLUDE[d365fin](includes/d365fin_md.md)] et que vous ne trouvez pas les réponses dans cette documentation, vous pouvez demander à la communauté Dynamics NAV. Pour plus d'informations, voir [Communauté Dynamics NAV, Business Edition](https://community.dynamics.com/business). En outre, notre équipe d'assistance publie des conseils et des astuces. Pour plus d'informations, voir le [Blog de support Dynamics NAV](https://blogs.msdn.microsoft.com/dyn365finsupport).  
