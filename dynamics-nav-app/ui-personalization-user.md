...
---
# <a name="personalizing-your-workspace-using-the-dynamics-nav-web-client"></a>Personnalisation de votre espace de travail à l'aide du client Web Dynamics NAV
