...
Dans Dynamics NAV, les interactions désignent tous les types de communication entre votre société et vos contacts. Par exemple, les communications peuvent s'effectuer par lettre, par e-mail, par télécopie,par téléphone, et ainsi de suite.
...
* [Configuration de modèles interaction](#setting-up-interaction-templates)
* [Création d'interactions sur les contacts ou les segments](#creating-interactions-on-contacts-or-segments)
* [Affichage et gestion des interactions enregistrées](#view-and-manage-recorded-interactions)
...
Vous pouvez supprimer les écritures journal interaction ayant été annulées. Pour supprimer des écritures journal interaction, dans le coin supérieur droit, sélectionnez l'icône **Page ou état pour la recherche**, entrez **Supprimer les écritures journal interaction annulées**, puis sélectionnez le lien connexes et renseignez les informations.
