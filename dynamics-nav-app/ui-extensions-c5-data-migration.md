...
# <a name="the-c5-data-migration-extension-for-dynamics-nav"></a>L'extension C5 Data Migration pour Dynamics NAV
...
> [!Note]
> Rappelez-vous que seules les écritures ouvertes sont migrées. Vous ne trouverez aucune donnée d'historique.
