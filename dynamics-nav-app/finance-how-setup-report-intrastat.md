...
2. Sur la page **Feuille intracomm.**, dans le champ **Nom de la feuille**, sélectionnez la feuille concernée, puis choisissez le bouton **OK**.  
...
5. Dans la fenêtre de traitement par lots, choisissez le bouton **OK**.  
